...
namespace VRCTools.World.Editor.LocalValues.UI {
  [CustomEditor(typeof(LocalUrlLabel))]
  public class LocalUrlLabelEditor : AbstractCustomUdonEditor {
    ...
    private void OnEnable() { this._localValue = this.serializedObject.FindProperty(nameof(LocalUrlLabel.localValue)); }
