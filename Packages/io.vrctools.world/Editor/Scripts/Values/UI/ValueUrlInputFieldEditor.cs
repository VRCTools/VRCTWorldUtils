...
namespace VRCTools.World.Editor.Values.UI {
  [CustomEditor(typeof(ValueUrlInputField))]
  public class ValueUrlInputFieldEditor : AbstractCustomUdonEditor {
    ...
    private void OnEnable() {
      this._source = this.serializedObject.FindProperty(nameof(ValueUrlInputField.source));
      this._localValue = this.serializedObject.FindProperty(nameof(ValueUrlInputField.localValue));
      this._synchronizedValue = this.serializedObject.FindProperty(nameof(ValueUrlInputField.synchronizedValue));
    }
